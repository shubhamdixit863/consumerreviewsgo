...
'<li><span class="flaticon-tray"></span>' +locationPhone+ '</li>'+
'</ul>'+
'</div>'+
'</div>'+
...
var locations=[
    [locationData('images/resource/listing/1-1.jpg', '5', '7', 'listing-single.html', "Private Hotel-Spa",          'Santa Monica, CA', '+61 2 8236 9200 ', 'sky', 'flaticon-bed', 'Hotel', 'Now Closed', ), 40.94401669296697, -74.16938781738281, 1, '<i class="icon flaticon-bed"></i>'],
    [locationData('images/resource/listing/1-2.jpg', '5', '8', 'listing-single.html', "Moonlight Restourant",       'Santa Monica, CA', '+61 2 8236 9200 ', 'pink', 'flaticon-chef', 'Restaurant', 'Now Closed', ), 40.77055783505125, -74.26002502441406, 2, '<i class="icon flaticon-chef"></i>'],
    [locationData('images/resource/listing/1-3.jpg', '5', '9', 'listing-single.html', "Best Museum",                'Santa Monica, CA', '+61 2 8236 9200 ', 'purple', 'flaticon-museum', 'Art & History', 'Now Closed', ), 40.7427837, -73.11445617675781, 3, '<i class="icon flaticon-museum"></i>'],
    [locationData('images/resource/listing/2-1.jpg', '5', '6', 'listing-single.html', "Shop 3 Secret Bargain NYC ", 'Santa Monica, CA', '+61 2 8236 9200 ', 'green', 'flaticon-shopping-cart', 'Shopping', 'Now Closed', ), 40.70437865245596, -73.98674011230469, 4, '<i class="icon flaticon-shopping-cart"></i>'],
    [locationData('images/resource/listing/2-2.jpg', '5', '5', 'listing-single.html', "Moonlight Restourant ",     'Santa Monica, CA', '+61 2 8236 9200 ', 'pink', 'flaticon-fork', 'Restaurant', 'Now Closed', ), 40.641311, -73.778139, 5, '<i class="icon flaticon-fork"></i>'],
    [locationData('images/resource/listing/2-3.jpg', '5', '4', 'listing-single.html', "Tom's Restaurant", 'Santa Monica, CA', '+61 2 8236 9200 ', 'orange', 'flaticon-guitar', 'Restaurant', 'Now Closed', ), 41.080938, -73.535957, 6, '<i class="icon flaticon-guitar"></i>'],
    [locationData('images/resource/listing/2-4.jpg', '5', '3', 'listing-single.html', "Explore the Real Brooklyn ", 'Santa Monica, CA', '+61 2 8236 9200 ', 'dark-pink', 'flaticon-weightlifting', ' Gym & Fitness ', 'Now Closed', ), 41.079386, -73.519478, 7, '<i class="icon flaticon-weightlifting"></i>'],
];
